...
export class ChaCha20 implements Streamcipher {
   ...
   */
	private init(key: Uint8Array, nonce: Uint8Array, counter = 0): ChaCha20 {
   ...
   */
	encrypt(key: Uint8Array, pt: Uint8Array, iv: Uint8Array, cnt = 0): Uint8Array {
   ...
   */
	decrypt(key: Uint8Array, ct: Uint8Array, iv: Uint8Array, cnt = 0): Uint8Array {
