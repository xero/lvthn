...
export class Random {
   ...
   */
	constructor(numPools = 32, entropy?: Uint8Array) {
		// constants
   ...
   */
	private addRandomEvent(data: Uint8Array, pool_idx: number, entropy = 1): void {
	...
	private collectorMouse(ev: MouseEvent): void {
		const x = ev.x || ev.clientX || ev.offsetX || 0,
	...
	private collectorScroll(_: Event): void {
